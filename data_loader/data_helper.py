...
def load_dataset(ds_name):
    ...
    :return: two numpy arrays of shape (num_of_graphs).
            the graphs array contains in each entry a ndarray represent adjacency matrix of a graph of shape
            (num_vertex_labels, num_vertex, num_vertex)
