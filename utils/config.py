...
CHOSEN_EPOCH = {'COLLAB': 100, 'IMDBBINARY': 40, 'IMDBMULTI': 150, 'MUTAG': 20, 'NCI1': 99, 'NCI109': 99, 'PROTEINS': 20, 'PTC': 9}
TIME = '{:%Y_%m_%d_%H_%M_%S}'.format(datetime.datetime.now())


# modified by Chen
NUM_LABELS = {'MUTAG': 1}
LEARNING_RATES = {'MUTAG': 1e-3, }
DECAY_RATES = {'MUTAG': 0.7, }
CHOSEN_EPOCH = {'MUTAG': 0, }
